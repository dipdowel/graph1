...
/// @obsolete use rgba_math() instead!
/// Allows adding or subtracting RGBA color values, color by color.
...
mod tests {
    ...
    fn test_add_colors() {
        ...
        assert_eq!(
            argb_math(&color1, &color2, &ColorOperation::Add),
            0xff_33_77_44
        );
    ...
    fn test_subtract_colors() {
        ...
        assert_eq!(
            argb_math(&color1, &color2, &ColorOperation::Subtract),
            0x00_40_50_60
        );
