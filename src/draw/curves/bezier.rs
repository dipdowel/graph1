...
// use crate::utils::color::invert::invert_colors;
//
...
//         let p1: &Point<i32> = &control_points[i];
//         let p2: &Point<i32> = &control_points[i + 1];
...
//         let control_color: u32 = control_color.unwrap_or(ctx.win.foreground_color);
//
