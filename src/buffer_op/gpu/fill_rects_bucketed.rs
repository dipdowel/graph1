...
pub fn fill_rects_bucketed_get_kernel<T: Numeric + Copy + 'static>(
    ...
    {
        let num_buckets =
            num_buckets.unwrap_or_else(|| choose_num_buckets(rects, buf_dimensions.w, 4, 32));
        ...
        let offsets_buf = Buffer::<u32>::builder()
            ...
            .build()
            .map_err(|e| format!("Failed to create OpenCL bucket_offsets buffer: {e}"))?;
        ...
        let counts_buf = Buffer::<u32>::builder()
            ...
            .build()
            .map_err(|e| format!("Failed to create OpenCL bucket_counts buffer: {e}"))?;
